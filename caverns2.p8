...
set_hair_color=function(djump)
	pal(9,(djump==1 and 9 or djump==2 and (7+flr((frames/3)%2)*3) or 6))
end
...
local no_entry_anim_levels = {13} -- add level ids here
...
player_spawn = {
	init = function(this)
		...
		if is_in_list(lvl_id, no_entry_anim_levels) then
			this.y = this.target -- no movement
			this.spd.y = 0
			this.state = 2 -- skip straight to landing
			this.delay = 5
		else
			this.y = min(this.y + 48, lvl_ph)
			this.spd.y = -4
...
local __init = _init function _init() __init() begin_game() load_level(12) music(-1) end
--@end
...

